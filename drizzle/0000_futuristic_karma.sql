...
CREATE TABLE "profile" (
	...
	"image" text,
	CONSTRAINT "profile_TIN_unique" UNIQUE("TIN")
);
--> statement-breakpoint
...
ALTER TABLE "message" ADD CONSTRAINT "message_admin_id_user_id_fk" FOREIGN KEY ("admin_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "notification" ADD CONSTRAINT "notification_admin_id_user_id_fk" FOREIGN KEY ("admin_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "catagory_id_idx" ON "product" USING btree ("catagory_id");--> statement-breakpoint
CREATE INDEX "profile_userId_idx" ON "profile" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "profile_subCity_idx" ON "profile" USING btree ("sub_city");--> statement-breakpoint
